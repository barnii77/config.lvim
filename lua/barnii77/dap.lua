...
-- local function get_codelldb_adapter(c_path, lib_path)
--   local r = require("barnii77.rust")
--   local d
--   if r == require("barnii77.rust_rustaceanvim") then
--     d = require("rustaceanvim.config")
--   else
--     d = require("rust-tools.dap")
--   end
--   return d.get_codelldb_adapter(c_path, lib_path)
-- end
